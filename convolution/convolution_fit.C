...
void convolution_fit(){
  ...
  shift_waveform(hsphe, starting_max-68);
...
//       out << param[i] << " +/- " << Erparam[i] << endl;
    ...
    cout << "fast integral = " << fast_integral << endl;
    cout << "slow integral = " << slow_integral << endl;
    cout << "Af = " << fast_integral/total_integral << endl;
    cout << "As = " << slow_integral/total_integral << endl;
    cout << "\n\nReal chi2 = " << realchi2 << endl;
    cout << "Real NDF = " << realNDF << endl;

    TLegend *pleg = new TLegend(0.54,0.29,0.89,0.89, "");
