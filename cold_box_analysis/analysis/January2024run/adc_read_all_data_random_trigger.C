...
void adc_read_all_data_random_trigger(string datadir = "./"){
    ...
    r.chargeTime = 40000; // last time to integrate
    r.startCharge = 10000;
    r.maxRange = 40000; // max range to search for amplitude peak
    ...
    r.filter = 8; // denoise filter.. if filter = 0, no denoise is done. r.OnlyOneEvent = false; // Do you want only one event? Choose it wisely
