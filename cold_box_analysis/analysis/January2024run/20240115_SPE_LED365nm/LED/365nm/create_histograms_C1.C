...
void create_histograms_C1(string channel = "Ch0.", vector<Int_t> _range_file = {0,-1}, Double_t lower_led_fit = 4.5, Double_t upper_led_fit = 11, Double_t upper_phe_fit = 1600, bool istest = true);

void run_C1(string channel = "Ch0.", vector<Int_t> _range_file = {0,-1}, Double_t lower_led_fit = 4.5, Double_t upper_led_fit = 11, Double_t upper_phe_fit = 1500, bool istest = true){
  create_histograms_C1(channel, _range_file, lower_led_fit, upper_led_fit, upper_phe_fit, istest);
}

void run_C2(string channel = "Ch2.", vector<Int_t> _range_file = {0,31}, Double_t lower_led_fit = 4.5, Double_t upper_led_fit = 5.8, Double_t upper_phe_fit = 1900, bool istest = true){
  create_histograms_C1(channel, _range_file, lower_led_fit, upper_led_fit, upper_phe_fit, istest);

}
void run_C3(string channel = "Ch4.", vector<Int_t> _range_file = {0,44}, Double_t lower_led_fit = 4.5, Double_t upper_led_fit = 8, Double_t upper_phe_fit = 1450, bool istest = true){
  create_histograms_C1(channel, _range_file, lower_led_fit, upper_led_fit, upper_phe_fit, istest);

}
void run_C4(string channel = "Ch6.", vector<Int_t> _range_file = {0,42}, Double_t lower_led_fit = 4.5, Double_t upper_led_fit = 7.8, Double_t upper_phe_fit = 1550, bool istest = true){
  create_histograms_C1(channel, _range_file, lower_led_fit, upper_led_fit, upper_phe_fit, istest);
}

void create_histograms_C1(string channel = "Ch0.", vector<Int_t> _range_file = {0,-1}, Double_t lower_led_fit = 4.5, Double_t upper_led_fit = 11, Double_t upper_phe_fit = 1600, bool istest = false){
  ...
  if(mychannel == "Ch0."){minInt = 3200; maxInt = 5200;}
  if(mychannel == "Ch1."){minInt = 3200; maxInt = 5200;}
  if(mychannel == "Ch2."){minInt = 3200; maxInt = 5200;}
  if(mychannel == "Ch3."){minInt = 3200; maxInt = 5200;}
  if(mychannel == "Ch4."){minInt = 3200; maxInt = 5200;}
  if(mychannel == "Ch5."){minInt = 3200; maxInt = 5200;}
  if(mychannel == "Ch6."){minInt = 3200; maxInt = 5200;}
  if(mychannel == "Ch7."){minInt = 3200; maxInt = 5200;}
