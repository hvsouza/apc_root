...
void giveMeSphe_20us(int channel = 0){
    ...
    dark.start  = 8300;            // start the search for peaks or start the integration (led)
    dark.finish = 9500;        // fisish the search or finish the integration (led)
    ...
    dark.mean_after    = dark.start-2300+14000;
