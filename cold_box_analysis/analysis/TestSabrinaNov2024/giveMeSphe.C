...
void giveMeSphe(int channel = 8){
    ...
    dark.start  = 10800;            // start the search for peaks or start the integration (led)
    dark.finish = 11600;        // fisish the search or finish the integration (led)

    dark.filter = 24;   // one dimentional denoise filter (0 equal no filder)
