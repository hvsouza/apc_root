...
void giveMeSphe(){
    ...
    dark.start  = 3750;            // start the search for peaks or start the integration (led)
    ...
    dark.mean_after    = 7000;
    dark.sphe_charge   = 3420.19; // charge of 1 and 2 p.e. (use fit_sphe.C)
    dark.sphe_charge2  = 6845.88;
    dark.sphe_std      = 561.947;
