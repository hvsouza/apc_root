...
void giveMeSphe(){
    ...
    dark.start  = 10054;            // start the search for peaks or start the integration (led)
    dark.finish = 10180;        // fisish the search or finish the integration (led)
    ...
    dark.mean_after    = 12000;
    dark.sphe_charge   = 238.16  ; // charge of 1 and 2 p.e. (use fit_sphe.C)
    dark.sphe_charge2  = 477.77  ;
    dark.sphe_std      = 58.3582 ;
