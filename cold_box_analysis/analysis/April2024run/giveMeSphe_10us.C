...
void giveMeSphe_10us(int channel = 0){
    ...
    dark.start  = 3320;            // start the search for peaks or start the integration (led)
    dark.finish = 4520;        // fisish the search or finish the integration (led)
