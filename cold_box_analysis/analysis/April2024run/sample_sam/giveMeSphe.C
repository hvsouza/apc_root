...
void giveMeSphe(int channel = 1){
    ...
    dark.start  = 1480;            // start the search for peaks or start the integration (led)
    dark.finish = 2100;        // fisish the search or finish the integration (led)
