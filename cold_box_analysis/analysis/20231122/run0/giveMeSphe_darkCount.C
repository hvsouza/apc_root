...
void giveMeSphe_darkCount(){
    ...
    dark.start = 2560; // start the search for peaks or start the integration (led)
    dark.finish = 2650; // fisish the search or finish the integration (led)
    ...
    dark.sphe_charge_ch0 = 4000; //wave0
    dark.sphe_charge2_ch0 = 8000; // wave0
